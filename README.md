...
This is the repository for **HumTrans: A Novel Open-Source Dataset for Humming Melody Transcription and Beyond**. To use the whole dataset, please refer to this [link](https://huggingface.co/datasets/dadinghh2/HumTrans).
